        ...
        child: Scaffold(
          appBar: ThemedAppBar(
              title: args.propertyAction == PropertyAction.newProperty
                  ...
                  : "Edit a property",
              childrenMessages: [
                Text("1. Click legend label to change visibility of data",
                    style: Theme.of(context).textTheme.bodySmall),
                const SizedBox(height: 10),
                Text("2. Click each track to show score",
                    style: Theme.of(context).textTheme.bodySmall),
                const SizedBox(height: 10),
                Text("3. Criteria legends can be scrolled vertically",
                    style: Theme.of(context).textTheme.bodySmall),
                const SizedBox(height: 10),
                Text("4. Swiped up and down to change score",
                    style: Theme.of(context).textTheme.bodySmall),
                const SizedBox(height: 10),
